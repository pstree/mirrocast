...
class DlnaMediaRenderer {
    ...
    companion object {
        private const val TAG = "DlnaMediaRenderer"
    }
    ...
    fun setAVTransportURI(uri: String, metadata: String) {
        ...
        Log.i(TAG, "DLNA SetAVTransportURI: ${state.uri}, playlist size=${state.playlist.size}")
    ...
    fun seek(target: String) {
        ...
        Log.i(TAG, "DLNA Seek: $target -> $position ms")
    ...
    fun setQualityUri(uri: String) {
        ...
        if (decoded.isNotBlank()) {
            state.uri = decoded
            Log.i(TAG, "DLNA SetQualityURI: $decoded")
    ...
    fun setVolume(volume: Int) {
        ...
        Log.i(TAG, "DLNA SetVolume: ${state.volume}")
        onVolumeChanged?.invoke(state.volume)
    }

    fun setMute(muted: Boolean) {
        state.muted = muted
        Log.i(TAG, "DLNA SetMute: $muted")
